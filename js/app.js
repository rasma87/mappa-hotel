...
function loadImage(poi) {
    ...
    // Se il POI ha un'immagine custom impostata esplicitamente, usala sempre
    if (poi.img) { applyImg(imgEl, poi.img, wrap, poi); return; }
    ...
    if (!page) { showFallback(wrap, poi); return; }
